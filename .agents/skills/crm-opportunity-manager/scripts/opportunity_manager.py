...
ENGAGEMENT_MANAGER_PATH = os.path.join(PROJECT_ROOT, ".agents", "skills", "crm-engagement-manager", "scripts", "engagement_manager.py")
...
def build_opportunity_body(opportunity_name, primary_contact_name, summary, next_steps, influencers):
    rendered = render_template(
        OPPORTUNITY_TEMPLATE_PATH,
        {
            ...
            "Product or Service Name": "Advisory",
...
def cmd_create(args):
    ...
    rendered = render_template(
        OPPORTUNITY_TEMPLATE_PATH,
        {
            ...
            "Product or Service Name": args.product_service or "Advisory",
