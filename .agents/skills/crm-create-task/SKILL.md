...
2. If the task belongs to an existing opportunity, prefer [opportunity_manager.py](/Users/johnjanuszczak/Projects/crm-logic/.agents/skills/crm-opportunity-manager/scripts/opportunity_manager.py) `spawn-task`.
