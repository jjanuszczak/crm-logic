...
_SPEC = importlib.util.spec_from_file_location("crm_finance_manager_impl", SKILL_SCRIPT_PATH)
if _SPEC is None or _SPEC.loader is None:
    raise ImportError(f"Unable to load finance manager implementation from {SKILL_SCRIPT_PATH}")
